...
type Trace interface {
	// // SetTraceIDService set TraceID generator, default startIDGenerator
	// SetTraceIDService(IDService)
	// // SetTraceIDService set SpanID generator, default startIDGenerator
